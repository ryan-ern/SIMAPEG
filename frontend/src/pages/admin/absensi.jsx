...
import { deleteMessage, getPresence, updatePresence } from "../../store/saga/actions"
                ...
                Cell: ({ row }) => (
                    <>
                        <div className='text-center'>
                            ...
                            <button className="btn btn-primary px-4 my-3" disabled={row.original.presence_out==="-" || row.original.status==='diterima'} onClick={(e) => {
                                e.preventDefault();
                                dispatch(updatePresence(row.original.id, terima ));
                            }}
                            >Terima</button>
                        </div>
                        <div className='text-center'>
                            <button className="btn btn-danger px-3" disabled={row.original.presence_out==="-"} onClick={(e) => {
                                e.preventDefault();
                                dispatch(updatePresence(row.original.id, tolak));
                            }}>Tolak</button>
                        </div>
                    </>
                ),
